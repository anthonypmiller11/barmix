  ...
  return (
    <div className="flex gap-1 h-8 lg:w-56 relative group">
      <Link to="/">
        ...
        <span className={`first-letter:text-app-flame first-letter:text-[40px] font-bold font-app-heading text-2xl absolute -bottom-2 left-[8px] cursor-pointer md:basic-transition md:group-hover:text-app-flame md:group-hover:text-[40px] md:group-hover:left-8 whitespace-nowrap ${alt ? "text-white" : "text-app-cadet"}`}>
