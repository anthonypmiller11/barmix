      ...
      >
        <div className="rounded-[8px] overflow-hidden">
          ...
          <div className="mx-1 md:mx-2 lg:mx-3 pb-1 md:pb-[6px] lg:pb-2">
            ...
            {loading === HTTP_STATUS.FULFILLED && (
              <>
                <p className="text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] text-center font-app-text text-app-thin-flame truncate leading-5 font-cocktail-name cocktail-name  font-weight-cocktail-name ">
